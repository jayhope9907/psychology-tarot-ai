...
$shareObj = [ordered]@{
    ...
    disability = "$publicUrl/disability"
...
Write-Host "보관 : $($shareObj.disability)  (장애인용 별도)"
Write-Host "그림 : $($shareObj.disability_picto)"
Write-Host "라이선스: $($shareObj.associations)"
Write-Host "마음 : $($shareObj.clinical)"
Write-Host "표현 : $($shareObj.picture_assessment)"
Write-Host "혁신 : $($shareObj.innovation)"
Write-Host "에이전트: $($shareObj.agent_lab)"
