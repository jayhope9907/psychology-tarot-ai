...
| **INV-09** | 가중 키워드 즉시반응 다층 라우팅 | 학파·기법·앱기능을 가중 매핑해 즉시 지시문 주입 |
| **INV-10** | 5축 기분 맞춤 검사·톤 게이팅 | 입체 체크인 좌표로 대화·검사 타이밍 분기 |
| **INV-11** | 오프라인 키워드·타로 번들 동기화 | 단절 시 폴백, 복귀 시 큐 동기화 |
| **INV-12** | 소비자/기관 이중 제품 분리 | open consumer vs license-gated surfaces |
