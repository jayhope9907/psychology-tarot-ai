...
DISCIPLINE_PROFILES: Dict[str, Dict[str, Any]] = {
    ...
    AssociationDiscipline.CLINICAL_PSYCH_TRAINEE.value: {
        ...
        "label_ko": "임상심리 수련",
        "tagline": "검사 배터리 · 사례 개념화 · 슈퍼비전 실습",
        "primary_lens": "심리평가(Assessment) · 사례 개념화 · 수련 기록",
        "what_we_optimize": [
            "표준화 스크리닝 + 그림·잉크·TAT 표현 배터리 (수련용)",
            "사례 개념화·측정 해석 연습 · 슈퍼바이저 피드백 보조",
            "종단 psych timeline · 수련생 케이스 노트",
            "마음 돌보기 허브 · DSM 스펙트럼 참고(비진단)",
        ],
        "what_we_de_emphasize": [
            "독립 진단·공식 심리검사 실시 자격 대체",
            "약물·처방·응급 의료 개입",
        ],
        "hero_stat": "수련 · 평가 배터리",
        "color": "#2563eb",
        ...
        "legal_framing_ko": (
            "임상심리 수련 라이선스는 **수련생·슈퍼비전 교육 보조**용입니다. "
            "임상심리사 자격·공식 심리검사 실시·진단을 대체하지 않으며, "
            "수련기관·슈퍼바이저 지도 하에서만 사용합니다."
        ),
    },
    AssociationDiscipline.MH_SOCIAL_WORK.value: {
        "discipline_id": AssociationDiscipline.MH_SOCIAL_WORK.value,
        "label_ko": "정신보건사회복지사 수련",
        "tagline": "사례관리 · 심리사회 · 지역사회 연계",
        "primary_lens": "사례관리(Case Management) · 심리사회 · 자원 연계",
        "what_we_optimize": [
            "심리사회 사정 · 강점·환경·지지체계 탐색",
            "우울·불안·스트레스·수면 짧게 확인 (스크리닝)",
            "위기·연계 신호 인식 · 지역 정신건강 서비스 안내",
            "상담 단계·숙제·행동 기록 · 수련생 사례관리 노트",
        ],
        "what_we_de_emphasize": [
            "깊은 투사·무의식 해석·타로",
            "진단명 확정·약물·처방 안내",
        ],
        "hero_stat": "사례관리 · 지역 연계",
        "color": "#0d9488",
        "icon": "🏠",
        "allowed_instruments": [
            "phq9",
        ...
        "allowed_projective": ["htp", "dap", "kfd", "sct"],
        "feature_flags": {
            "counseling_theories_full": True,
            "counseling_phases": True,
            "homework_packages": True,
        ...
        "legal_framing_ko": (
            "정신보건사회복지사 수련 라이선스는 **수련·사례관리 교육 보조**용입니다. "
            "정신건강사회복지사 자격·의료·상담 면허를 대체하지 않으며, "
            "수련기관·슈퍼바이저·지역 정신건강복지센터 연계를 전제로 합니다."
        ),
    },
