...
DSM5_SPECTRA: Dict[str, Dict[str, Any]] = {
    ...
    "substance_behavioral": {
        ...
        "dsm_chapter": "DSM-5-TR · 물질·중독 (스크리닝)",
        "instruments": ["behavioral", "pss", "micro_emotion"],
        "theories": [ClinicalSchool.MOTIVATIONAL, ClinicalSchool.ACT, ClinicalSchool.BECK_CBT],
        "techniques": ["동기 강화", "트리거 분석", "대체 행동", "가치 재연결", "전문 연계"],
        "founders": ["William Miller", "Steven Hayes"],
        "keywords": ("술", "담배", "중독", "과몰입", "게임", "폭식", "습관"),
    },
    "somatic_distress": {
