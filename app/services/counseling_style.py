...
COUNSELORS: Dict[str, Dict[str, Any]] = {
    ...
    "jieun": {
        ...
        "tagline": "지금-여기 알아차림 · 신체 감각",
        "primary_school": "GESTALT",
        "secondary_schools": ["MINDFULNESS", "EFT"],
        "techniques": ["지금-여기 초점", "신체 감각", "알아차림", "접촉 경계"],
        "bio": "게슈탈트·마음챙김 통합 훈련. 현재 순간의 경험과 몸의 신호를 함께 살펴봅니다.",
...
USER_COUNSELOR_LABELS: Dict[str, Dict[str, str]] = {
    ...
    "jieun": {"user_title": "지금 마음 상담", "user_specialty": "차분한 알아차림"},
